...
def douban_link2mdtext(douban_link: str) -> str:
    ...
    sub_id = m.group(1)
    r = httpx.get(
        f"https://api.douban.com/v2/movie/subject/{sub_id}?apikey=0df993c66c0c636e29ecbb5344252a4a")
...
# usage example
#mdtext = douban_link2mdtext("https://movie.douban.com/subject/1301419/")
# print(mdtext)
